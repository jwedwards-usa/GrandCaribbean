(()=>{
  ...
  function sourceLine(record){
    return `<p class="carousel-source source-note"><strong>Photo source:</strong> <a href="${esc(record.sourceUrl)}" target="_blank" rel="noopener noreferrer">${esc(record.sourceLabel)}</a> · <strong>Image date:</strong> ${esc(record.imageDate||'Not published by source')} · source checked ${esc(record.checked||'2026-08-19')}.</p>`;
  }
