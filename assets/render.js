...
const propertyPhotoSource='https://www.portaescapes.com/rentals/grand-caribbean-gc1007';
const propertyPhotos=[
  {src:'https://track-pm.s3.amazonaws.com/paescapes/image/bd2dcb12-3895-4503-a970-c5ab90654e4a',alt:'Grand Caribbean building and boardwalk through the coastal dunes'},
  {src:'https://track-pm.s3.amazonaws.com/paescapes/image/eea916bc-c3fb-4180-ae50-b4a4000d46f7',alt:'Grand Caribbean yellow beachfront building and curved swimming pool'},
  {src:'https://track-pm.s3.amazonaws.com/paescapes/image/243e8cf9-acdd-4d0b-8041-bfa0ad688dac',alt:'Grand Caribbean pool deck overlooking the dunes and beach boardwalk'}
];
const propertyPhoto=(src,width=1100)=>`https://images.weserv.nl/?url=${encodeURIComponent(src)}&w=${width}&q=70&output=webp`;
...
function gallery(){
  return `<div class="gallery" aria-label="Grand Caribbean property photos">${propertyPhotos.map(p=>`<a href="${propertyPhotoSource}" target="_blank" rel="noopener"><img src="${propertyPhoto(p.src)}" alt="${esc(p.alt)}" loading="lazy" decoding="async"></a>`).join('')}</div><p class="source-note"><strong>Property photos:</strong> <a href="${propertyPhotoSource}" target="_blank" rel="noopener">current Grand Caribbean rental listing</a> · <a href="https://dunecrest.com/" target="_blank" rel="noopener">Grand Caribbean at Dune Crest site</a>.</p>`;
}
function card(u){
